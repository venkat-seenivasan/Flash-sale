                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
						 <a href="ecomm.php" class="nav-item nav-link  ">E-COMMERCE DETAILS</a>
                           <a href="aoffer.php" class="nav-item nav-link  ">OFFER DETAILS </a> 
						    <a href="apre.php" class="nav-item nav-link  ">PREMIUM DETAILS </a>     
				  <a href="report.php" class="nav-item nav-link ">USER DETAILS </a>   
...
<h2 style="font-family:Arial, Helvetica, sans-serif   text-shadow: 1px 1px #7E4D0E;   text-decoration: none;   color: #FFF;  margin-right: 2px; font-size:25px">OFFER DETAILS</h2>
...
<?php
$result=mysql_query("Select * from tb_offer   ");
 ...
 <tr>
        ...
        <td ><?php echo $row['etype']; ?></td>
		 ...
		 <td ><?php echo "<a href=$im><img src=home/$im width=100 height=80></img></a>";?></td>
		  <td align="center"><div align="center"><?php echo "<a href=delete.php?id=$row[id]>"; ?><img src="img/delete.png" style='width:20px;height:20px'/> </a>      </div></td>
		 </div>
		</tr>
		</tbody> 
