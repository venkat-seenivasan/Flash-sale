...
<head>
    ...
    <style>
        ...
        .lgnbtn {
            font: 60% 'Yanone Kaffeesatz', arial, sans-serif;
            border: 0;
            width: 99px;
            ...
            <td>
                <CENTER>
                    <div class="loginhead3" style="width:55%">
                        ...
                        <h2 style="text-align:center;color: #FFF;  margin-right: 2px; font-size:40px">REVIEW</h2>
                    </div>
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            <form name="f1" method="post" action="reviewdata.php">
                                                <table width=65% height="500" border="0" align="center"
                                                    style="margin:auto;">


                                                    <tr>

                                                        <td width="228"><input name="id" type="hidden" id="id"
                                                                value="<?php echo $id; ?>" class="txt" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td><span class="style7">Date </span></td>
                                                        <td><input name="edate" type="text" id="edate" class="txt"
                                                                value="<?php echo date('d-m-Y'); ?>" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td><span class="style7">User Name </span></td>
                                                        <td><input name="uname" type="text" id="uname" class="txt"
                                                                value="<?php echo $uname; ?>" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td><span class="style7">Product Name </span></td>
                                                        <td><input name="fname" type="text" id="fname" class="txt"
                                                                value="<?php echo $row["ename"] ?>" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td><span class="style7">Price </span></td>
                                                        <td><input name="price" type="text" id="price" class="txt"
                                                                value="<?php echo $row["vtype"] ?>" />
                                                            <input name="pname" type="hidden" id="pname" class="txt"
                                                                value="<?php echo $row["uname"] ?>" />
                                                            <input name="img" type="hidden" id="img" class="txt"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea name="edesc" rows="5"
                                                                cols="30"><?php echo $row["edesc"] ?></textarea></td>
                                                    </tr>

                                                    <tr>
                                                        <td><span class="style7">Review</span></td>
