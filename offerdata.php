...
$quy=mysql_query("insert into tb_offer values('$cid','$cname','$s1','$email','$city','$phone','$cat','$eday','$edate','$cat1','$img','$uname')");
echo '<Center><br><br /><font color=green size=4>Successfully Upload your Details</a><br><br>';
