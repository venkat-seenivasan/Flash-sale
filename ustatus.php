            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
						...
						<a href="unvehicle.php" class="nav-item nav-link  ">QR Code Scan</a>    
				 
 					 <a href="ustatus.php" class="nav-item nav-link  ">Vehicle  Insurance </a>  
...
<h2 style="font-family:Arial, Helvetica, sans-serif   text-shadow: 1px 1px #7E4D0E;   text-decoration: none;   color: #FFF;  margin-right: 2px; font-size:25px">VEHICLE INSURANCE STATUS</h2>
...
<?php
$result=mysql_query("Select * from tb_ins ");
