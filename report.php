...
<h2 style="font-family:Arial, Helvetica, sans-serif   text-shadow: 1px 1px #7E4D0E;   text-decoration: none;   color: #FFF;  margin-right: 2px; font-size:25px">USER DETAILS</h2>
...
<?php
$result=mysql_query("Select * from tb_breg  where etype='User'");
