...
<h2 style="font-family:Arial, Helvetica, sans-serif   text-shadow: 1px 1px #7E4D0E;   text-decoration: none;   color: #FFF;  margin-right: 2px; font-size:25px">E-COMMERCE DETAILS</h2>
  ...
  <tr>
    <td>Type</td>
    <td><select  name="etype" class="txt" >
...
<?php
$result=mysql_query("Select * from tb_breg  where status='$etype' and etype='Seller'");
