            ...
            <td>
                <CENTER>
                    <div class="loginhead3" style="width:55%">
                        ...
                        <h2 style="text-align:center;color: #FFF;  margin-right: 2px; font-size:20px">REVIEW</h2>
                    </div>
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            <form name="f1" method="post" action="reviewdata.php">
                                                ...
                                                $q = "insert into tb_review values ('','$edate','$fname','$price','$edesc','$address','$pname','$uname','$id','$img')";

                                                mysql_query($q) or die(mysql_error());

                                                echo '<Center><font color=green size=4>Successfully Review Posted</a><br><br>';
