...
<?php
$result=mysql_query("Select * from tb_offer where uname='$uname' ");
 ...
 <tr>
        ...
        <td ><?php echo $row['etype']; ?></td>
		 ...
		 <td   bgcolor="#999999">
		<?php  echo '<a href="paydata.php?id='.$row["id"].'" style="background:#00CC66; color:#FFFFFF; padding:10px; text-decoration:none; border-radius:15px">PREMIUM</a>';	 
