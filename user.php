...
<head>
    ...
    <style>
        ...
        .aaa {
            ...
            font: 90% 'Yanone Kaffeesatz', arial, sans-serif;
            border: 0;
            width: 99px;
...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto"> <a href="index.php" class="nav-item nav-link ">HOME</a>
                        ...
                        <a href="user.php" class="nav-item nav-link active">LOGIN</a>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="contact-info">
                        ...
                        <div class="contact-info-item" style="padding:50px">
                        ...
                        <form name="f1" method="post" action="logdata.php">
                            <table width="90%" border="0" height="200px">
                                <tr>
                                    <td>User Name </td>
                                    <td><label>
                                            <input name="uname" type="text" class="txt" id="uname" required />
                                        </label></td>
                                </tr>
                                <tr>
                                    <td>Password</td>
                                    <td><input name="pass" type="password" class="txt" id="pass" required /></td>
                                </tr>
                                <tr>
                                    <td height="61">User Type</td>
                                    <td>
                                        <select name="etype" class="txt" required>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td> <a href="SRegister.php" class="aaa">New Registration</a></td>
                                </tr>
    ...
    <div class="footer">
        ...
        <div class="container copyright">
            <p>&copy; <a href="#">2024@</a>, All Right Reserved.
        </div>
    </div>
