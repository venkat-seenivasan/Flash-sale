...
<h2 style="font-family:Arial, Helvetica, sans-serif   text-shadow: 1px 1px #7E4D0E;   text-decoration: none;   color: #FFF;  margin-right: 2px; font-size:25px">QR SCAN CODE VIEW</h2>
  ...
  <tr>
    <td>QR CODE SCAN</td>
    <td>  <input name="etype" type="file" class="txt" id="etype" /></td>
...
<?php
$result=mysql_query("Select * from tb_vehicle  where img='$etype'");
