...
$q="INSERT INTO tb_ins VALUES('$proid','$edate','$proname','$qty','$price','$protype','$oname')";

             $status=mysql_query($q);

echo "<br><br><br><center><h3 style=color:red; font-size:16px>Successfully Saved</h3></center>";
