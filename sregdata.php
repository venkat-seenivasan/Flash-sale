            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">     <a href="index.php" class="nav-item nav-link active">HOME</a>
						        <a href="SRegister.php" class="nav-item nav-link">USER REGISTER</a>
...
<br>
        ...
        <!-- Contact Start -->
		 ...
		 <h2 style="font-family:Arial, Helvetica, sans-serif   text-shadow: 1px 1px #7E4D0E;   text-decoration: none;   color: #FFF;  margin-right: 2px; font-size:25px"> REGISTRATION</h2>
...
$q = "insert into tb_breg values ('$id','$ename','$gender','$phone','$address','$city','$email','$uname','$pass','$img','$etype','$etype1')";

mysql_query($q) or die (mysql_error());

 echo '<Center>  <br /><font color=green size=4>Successfully Register your Details</a><br><br>';

 ?>
 <a href="user.php" class="aaa">BACK  TO LOGIN</a>
