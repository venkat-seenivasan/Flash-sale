...
<h2 style="font-family:Arial, Helvetica, sans-serif   text-shadow: 1px 1px #7E4D0E;   text-decoration: none;   color: #FFF;  margin-right: 2px; font-size:25px">REVIEW DETAILS</h2>
...
<?php
$result=mysql_query("Select * from tb_review where owner='$uname' ");
 ...
 <tr>
		...
		<td ><?php echo $row['review']; ?></td>
		 ...
		 <td>  <?php echo "<a href=home/$im><img src=home/$im alt=Team Image style=height:100px; border:solid 5px #FF0000></img></a>";?></td>
