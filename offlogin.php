  ...
  text-shadow: 1px 1px #178497;
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-item" style="padding:25px">
		...
		<center>
							...
							<br><br>
                             <form name="f1" method="post" action="offlog.php">
		 <table width="90%" border="0" height="200px">
          ...
          <tr>
            ...
            <tr>
            <td>&nbsp;</td>
            <td> <a href="SRegister.php" class="aaa">New User Registration</a></td>
          </tr>
        </table>
                  </form>  
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-contact">
                            ...
                            <div class="footer-social">
                                ...
                                <a class="btn" href=""><i class="fab fa-linkedin-in"></i></a>                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-link">
                            ...
                            <a href="">Pricing Plan</a>                        </div>
                    </div>
                </div>
            </div>
            <div class="container copyright">
            <p>&copy; <a href="#">2024@</a>, All Right Reserved.            </div>
        </div>
