            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        ...
                        <a href="preuser.php" class="nav-item nav-link active  ">PREMIUM USER</a>
            ...
            <td>
                ...
                <div class="team">
                    <div class="container">
                        ...
                        <form action="" method="GET" class="form-inline mb-3">
                            <div class="input-group mr-3">
                                <input type="text" name="search" class="form-control"
                                    placeholder="Search for specific offer...">
                        ...
                        $rs = mysql_query("select * from tb_breg where uname='$uname' and status='Premium'");
                        $r = mysql_fetch_array($rs);

                        $n = mysql_num_rows($rs);
                        if ($r['uname'] == $uname && $r['status'] == 'Premium') {
                            ...
                            <div class="row">
                                ...
                                $query = "SELECT * FROM tb_offer  WHERE sta='Premium'";
                                if (!empty($search)) {
                                ...
                                while ($row = mysql_fetch_array($result)) {
                                    ...
                                    if (strtotime($current_date) <= strtotime($expiration_date)) {
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="team-item">
                                                <div class="team-img">
                                                    <a href="home/<?php echo $im; ?>"><img src="home/<?php echo $im; ?>"
                                                            alt="Team Image" style="height:200px;"></a>
                                                </div>
                                                <div class="team-text">
                                                    <h3 style="color:#FFFF00; font-weight:bold; font-size:16px">
                                                        <?php echo $row['ename']; ?>
                                                    </h3>
                                                    <h3 style="color:#FFFFFF;font-size:16px;font-weight:bold;">
                                                        <?php echo $row['edesc']; ?>
                                                    </h3>
                                                    <h3 style="color:#FFFF00; font-size:16px">
                                                        <?php echo $row['etype']; ?>&nbsp;
                                                    </h3>
                                                    <h3 style="color:#FFFFFF;font-size:16px;font-weight:bold;">
                                                        <?php echo "Offer Price:" . $row['vtype']; ?>
                                                    </h3>
                                                    <h3 style="color:#FFFF99; font-size:16px">Phone :
                                                        <?php echo $row['phone']; ?>&nbsp;
                                                    </h3>
                                                    <h3 style="color:#FFFF99; font-size:16px">Last Date :
                                                        <?php echo $row['eday']; ?>&nbsp;
                                                    </h3>
                                                    <br>
                                                    <h3 style="color:#FFFF99;font-size:16px;font-weight:bold;"><a href="#"
                                                            style="background:#00CC66; color:#FFFFFF; padding:10px; text-decoration:none; border-radius:15px">MEGA
                                                            OFFER</a></h3>
                                                    <br>
                                ...
                                if (!$found_offers && (!empty($search) || !empty($filter_etype))) {
                                    ?>
                                    <div class="col-lg-12">
                            ...
                            ?>
                                <Center>
                                    <h1 style="color:#FF0000; text-transform:uppercase">Your Not Elgible For Premium User
                                    </h1>
                                </Center>
                                <?php
                        }
